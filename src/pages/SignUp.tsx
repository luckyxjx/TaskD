...
import { MailIcon, LockIcon, GithubIcon } from '../icons';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-900 relative">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 max-w-xl w-full animate-scale-in z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Start your productivity journey today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {error && (
            <div className="bg-danger-50 dark:bg-danger-900/30 border border-danger-200 dark:border-danger-800 text-danger-700 dark:text-danger-400 px-4 py-3 rounded-xl text-sm animate-fade-in">
              {error}
            </div>
          )}
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-primary-700 dark:group-hover:text-primary-400">Google</span>
            </button>
            ...
            <button
              ...
              className="flex items-center justify-center px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-primary-300 dark:hover:border-primary-600 hover:bg-primary-50 dark:hover:bg-primary-900/20 hover:scale-105 active:scale-95 transition-all duration-200 group"
            >
              <GithubIcon className="w-5 h-5 text-gray-700 dark:text-gray-300 group-hover:text-primary-700 dark:group-hover:text-primary-400" />
              <span className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-primary-700 dark:group-hover:text-primary-400">GitHub</span>
            </button>
          </div>
        </div>
